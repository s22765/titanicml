...
def main():
	...
	st.set_page_config(page_title="s22765")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://m.media-amazon.com/images/I/81VOGb4JXsL._AC_UF1000,1000_QL80_.jpg")

	with overview:
		st.title("Czy przezylbys katastrofe Titanica?")
	...
	with right:
		...
		fare_slider = st.slider("Cena biletu", min_value=0, max_value=345, step=1)
